...
public class PetListHelper {
	...
	public void deletePet(PetList toDelete) {
		...
		EntityManager em = emfactory.createEntityManager();
		em.getTransaction().begin();
		TypedQuery<PetList> typedQuery = em.createQuery( "select pe from PetList pe where pe.type = :selectedType and pe.name = :selectedName and pe.owner = :selected", PetList.class);
